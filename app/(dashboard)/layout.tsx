...
export default function DashboardLayout({
  ...
  return (
    <div className="dashboard px-6xs py-6xs mb:px-0 mb:py-0">
      <Header className="flex-row gap-20xl pt-3xl pb-2xs px-5xl rounded-md aspect-[3.34/1] bg-cover bg-blue-desk shadow-box-1 tb:px-10xl tb:pt-8xl tb:pb-sm mb:flex-col mb:justify-normal mb:gap-10xl mb:px-8xl mb:pt-76xl mb:pb-5xl tb:rounded-s mb:rounded-none mb:shadow-box-2 mb:aspect-[3/2] mb:bg-blue-mob"/>
