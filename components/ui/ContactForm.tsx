...
const ContactForm = () => {
  ...
  return (
    <div className='contactform-container gap-6xs px-4xs py-5xs rounded-sm mb:px-md mb:py-2xs mb: mb:flex-grow'>
      <strong className='contactform-title text-4xs mb:text-5xl'>Deja un mensaje</strong>
      <form onSubmit={handleSubmit(onSubmit)} className="contactform-form gap-5xs mb:gap-xs">
        <div className='contactform-input-container relative gap-7xs'>
          <input
            ...
            className={`
              text-5xs rounded-sm px-6xs py-6xs placeholder:text-muted-foreground mb:text-4xl
            `}
          />
          {errors.email && (
        ...
        <div className='contactform-textarea-container relative gap-7xs'>
          <textarea
            ...
            placeholder="Mensaje"
            className={`
              text-5xs rounded-sm px-6xs py-6xs bg-background placeholder:text-muted-foregroun mb:text-4xl
            `}
            rows={2}
          />
          {errors.message && (
        ...
        <button type="submit" className={`text-5xs ${!isValid ? "pointer-events-none disabled:bg-gray-700" : ""} mb:text-4xl`} disabled={!isValid}>
          Enviar
        </button>
      </form>
    </div>
