...
const Projects = () => {
  ...
  return (
    <div className={`${styles['projects-container']} g-container glass gap-4xl px-12xl py-6xl tb:px-8xl tb:py-4xl mb:gap-16xl mb:px-12xl mb:py-12xl`}>
      <h2 className={`${styles['projects-title']} g-title text-xs font-medium mb:text-15xl`}>Proyectos</h2>
      <div className={styles['projects-subcontainer']}>
        {projectsState && projectsState.map((project, idx) => (
          <div className={styles['projects-card']} key={idx}>
